...
namespace ConsoleAppcore.Services
{
    public class EmailService: IEmailService
    {
        ...
        {
            userEmailOptions.Subject = UpdatePlaceHolders(" Hello {{UserName}}  This is test email subject from book app",userEmailOptions.PlaceHolders);
        ...
        private async Task SendEmail(UserEmailOptions userEmailOptions)
        {
            try 
            {
                ...
                //mail.From = new MailAddress("sindhusathyam26.2@gmail.com");
                MailMessage mail=new MailMessage
                {
                ...
                //mail.To.Add(new MailAddress("sindhusathyam26.2@gmail.com"));
